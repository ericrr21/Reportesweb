...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {label: 'Dato Fuente', icon: 'grid_on', routerLink: ['/datofuente'] },
            ...
            // {label: 'Registro', icon: 'input', routerLink: ['/afiliacion']},
            // {label: 'Servicios', icon: 'room_service', routerLink: ['/terceros'] },
        /*    {
